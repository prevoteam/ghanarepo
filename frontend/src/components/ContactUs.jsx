...
const ContactUs = ({ onBack, onLogoClick }) => {
        ...
        <div className="contactus-container">
          ...
          <div className="contactus-info">
            ...
            <div className="contact-section">
              <h2 className="contact-section-title">Headquarters</h2>
              <div className="contact-item">
                ...
                <div className="contact-text">
                  <p>Off Starlets 91 Road, Near Accra Sports Stadium</p>
                  <p>Ministries, Accra, Ghana</p>
                </div>
              </div>
            </div>
